...
DateTime::DateTime(const DateTime& _copy) : date_at_initialization {_copy.date_at_initialization},
date_local_first {_copy.date_local_first}, date_local_second {_copy.date_local_second},
...
auto DateTime::operator=(const DateTime& _copy) -> DateTime &
{
	if (&_copy != this)
	{
		date_at_initialization = _copy.date_at_initialization ;
		...
		time_at_initialization = _copy.time_at_initialization ;
